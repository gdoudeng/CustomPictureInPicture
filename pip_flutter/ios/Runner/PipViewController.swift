...
class PipViewController: UIViewController, AVPictureInPictureControllerDelegate {
    ...
    private func setupUI() {
        ...
        backButton.frame = .init(x: 20, y: 90, width: 80, height: 30)
    ...
    private func setupPlayer() {
        ...
        let mp4Video = Bundle.main.url(forResource: "竖向视频", withExtension: "mov")
    ...
    @objc private func transform() {
        ...
        let mp4Video = Bundle.main.url(forResource: videoName, withExtension: "mov")
        let asset = AVAsset.init(url: mp4Video!)
        let playerItem = AVPlayerItem.init(asset: asset)
    ...
    @objc private func rotate() {
        ...
        let mp4Video = Bundle.main.url(forResource: "方形视频", withExtension: "mov")
        let asset = AVAsset.init(url: mp4Video!)
        let playerItem = AVPlayerItem.init(asset: asset)
    ...
    func pictureInPictureControllerDidStopPictureInPicture(_ pictureInPictureController: AVPictureInPictureController) {
        print("画中画关闭 didStopPictureInPicture")
        stopTimer()
    }
